...
<footer class="bg_gray">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                	<div class="widget">
                        ...
                        <ul class="app_list">
                            <li><a href="#"><img src="{{ asset('images/f1.png')}}" alt="f1"/></a></li>
                            <li><a href="#"><img src="{{ asset('images/f2.png')}}" alt="f2"/></a></li>
                        </ul>
                    </div>
                	<div class="widget">
    ...
    <div class="bottom_footer border-top-tran">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="text-center text-md-start mb-md-0">© 2025 All Rights Reserved by localbazer.com</p>
                </div>
                <div class="col-lg-6">
