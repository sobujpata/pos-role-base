                                ...
                                <div class="d-lg-flex menu_banners row g-3 px-3">
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{ asset('images/menu_banner11.jpg')}}" alt="menu_banner1">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{ asset('images/menu_banner22.jpg')}}" alt="menu_banner2">
                                            <div class="banne_info">
                                                <h6>15% Off</h6>
                                                <h4>Wooden Chair</h4>
                                                <a href="#">Shop now</a>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{ asset('images/menu_banner33.jpg')}}" alt="menu_banner3">
                                            <div class="banne_info">
                                                <h6>23% Off</h6>
                                                <h4>Wooden Chair</h4>
                                                <a href="#">Shop now</a>
                                            ...
                                            <div class="header_banner_content">
                                                <div class="shop_banner">
                                                    <div class="banner_img overlay_bg_40">
                                                        <img src="{{ asset('images/shop_banner1.jpg')}}" alt="shop_banner"/>
                                                    </div> 
