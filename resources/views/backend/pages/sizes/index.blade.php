                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            ...
                                            @can('color-update')
                                            <a href="{{route('sizes.edit', $size->id)}}" class="btn btn-primary p-1"><i class='bx bx-pen'></i></a>
                                            @endcan
                                            @can('color-delete')
                                            <form action="{{ route('sizes.destroy', $size->id) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                @method('delete')
