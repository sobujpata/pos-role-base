        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                @can('category-create')
                    <div class="ms-auto">
                        <div class="btn-group">
                            <a href="{{ route('MainCategories.create') }}" class="btn btn-primary">Create category</a>
                        </div>
                    </div>
                @endcan
            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($categories as $key => $category)
                                        <tr>
                                            ...
                                            <td><img src="{{ 'storage/' . $category->categoryImg }}"
                                                    alt="{{ $category->categoryName }}" width="40"> </td>
                                            <td>
                                                <span class="d-flex gap-2">
                                                    ...
                                                    @endcan
                                                    @can('category-delete')
                                                        <form action="{{ route('MainCategories.destroy', $category->id) }}"
