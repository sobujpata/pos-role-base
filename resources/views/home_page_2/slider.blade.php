        	...
        	<div class="col-lg-9 offset-lg-3">
                <div id="carouselExampleControls" class="carousel slide light_arrow" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active background_bg" data-img-src="{{ asset('images/banner4.jpg') }}">
                        ...
                        <div class="carousel-item background_bg" data-img-src="{{ asset('images/banner5.jpg') }}">
                            <div class="banner_slide_content banner_content_inner">
                                <div class="col-lg-8 col-10">
                                    <div class="banner_content overflow-hidden">
                        ...
                        <div class="carousel-item background_bg" data-img-src="{{ asset('images/banner6.jpg') }}">
                            <div class="banner_slide_content banner_content_inner">
                                <div class="col-lg-8 col-10">
                                    <div class="banner_content overflow-hidden">
