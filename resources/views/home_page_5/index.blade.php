                                ...
                                <div class="heading_tab_header">
                                    ...
                                    <div class="tab-style2">
                                        ...
                                        <ul class="nav nav-tabs justify-content-center justify-content-md-end"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" id="arrival-tab" data-bs-toggle="tab"
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img1.jpg') }}"
                                                                alt="el_hover_img1">
                                                        </a>
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img2.jpg') }}"
                                                                alt="el_hover_img2">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img3.jpg') }}"
                                                                alt="el_hover_img3">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                    ...
                                                    <div class="product_info">
                                                        <h6 class="product_title"><a href="shop-product-detail.html">Nikon
                                                                HD camera</a></h6>
                                                        <div class="product_price">
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img4.jpg') }}"
                                                                alt="el_hover_img4">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img5.jpg') }}"
                                                                alt="el_hover_img5">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img6.jpg') }}"
                                                                alt="el_hover_img6">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img7.jpg') }}"
                                                                alt="el_hover_img7">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img8.jpg') }}"
                                                                alt="el_hover_img8">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img9.jpg') }}"
                                                                alt="el_hover_img9">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img10.jpg') }}"
                                                                alt="el_hover_img10">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img11.jpg') }}"
                                                                alt="el_hover_img11">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img"
                                                                src="{{ asset('images/el_hover_img12.jpg') }}"
                                                                alt="el_hover_img12">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                        ...
                                        <div class="deal_progress">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="28"
                                                    aria-valuemin="0" aria-valuemax="100" style="width:28%"> 28%
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="heading_tab_header">
                                    ...
                                    <div class="view_all">
                                        <a href="#" class="text_default"><i class="linearicons-power"></i>
