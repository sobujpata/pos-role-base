...
@section('content')
@include('home_page_5.slider')
@include('home_page_5.popup')
        	...
        	<div class="col-xl-3 d-none d-xl-block">
            	<div class="sale-banner">
                	<a class="hover_effect1" href="#">
                		<img src="{{ asset('images/shop_banner_img6.jpg')}}" alt="shop_banner_img6">
                    </a>
                </div>
            </div>
        	<div class="col-xl-9">
	...
	<div class="custom-container">
    	<div class="row">
        	<div class="col-xl-3 d-none d-xl-block">
            	<div class="sale-banner">
                	<a class="hover_effect1" href="#">
                		<img src="{{ asset('images/shop_banner_img10.jpg')}}" alt="shop_banner_img10">
                    </a>
                </div>
            </div>
        	<div class="col-xl-9">
