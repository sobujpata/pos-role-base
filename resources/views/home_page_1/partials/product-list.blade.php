    ...
    <div class="col-md-4 col-6">
        <div class="product">
                    ...
                    <ul class="list_none pr_action_btn">
                        <li class="add-to-cart"><a href="#" class="addToCartBtnAll"
                            data-id="{{ $product->id }}" 
                                   ...
                                   data-price="{{ (float)$product->discount_price }}"><i class="icon-basket-loaded"></i>
                                Add To Cart</a></li>
            ...
            <div class="product_info">
                <h6 class="product_title"><a href="{{ url('details/'.slugify($product->title).'-'.$product->id) }}">{{ $product->title }}</a></h6>
